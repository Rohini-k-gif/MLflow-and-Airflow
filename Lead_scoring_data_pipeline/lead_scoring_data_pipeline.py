...
constants = module_from_file("utils", "airflow/dags/Lead_scoring_data_pipeline/constants.py")
schema = module_from_file("data_validation_checks", "airflow/dags/Lead_scoring_data_pipeline/schema.py")
city_tier_mapping = module_from_file("utils", "airflow/dags/Lead_scoring_data_pipeline/mapping/city_tier_mapping.py")
significant_categorical_level = module_from_file("data_validation_checks", "airflow/dags/Lead_scoring_data_pipeline/mapping/significant_categorical_level.py")
